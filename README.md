...
|         RESTful API        	|                                 * JSON web interface to display all objects * Manipulation of objects via a RESTul API                                 	|
|         Web dynamic        	|                                            * JQuery * Loading of objects from client side using RESTful API                                            	|
